...
if __name__ == "__main__":
    ...
    intermediate_filename = os.path.join(OUTPUT_DIR, "intermediate.txt")
    out_pass1_filename = os.path.join(OUTPUT_DIR, "out_pass1.txt")
    symtab_filename = os.path.join(OUTPUT_DIR, "symbTable.txt")
    out_pass2_filename = os.path.join(OUTPUT_DIR, "out_pass2.txt")
    htme_filename = os.path.join(OUTPUT_DIR, "HTME.txt")
    ...
    print("All passes complete. Files generated in 'output' folder:")
    print(f"- {intermediate_filename}")
    print(f"- {out_pass1_filename}")
    print(f"- {symtab_filename}")
    print(f"- {out_pass2_filename}")
    print(f"- {htme_filename}")
